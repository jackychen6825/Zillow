...
const Search = ({ properties, updateFilter, minPrice, maxPrice, minBeds, minBaths, openModal }) => (
    ...
    <div>
        <FilterForm minPrice={minPrice} maxPrice={maxPrice} minBeds={minBeds} minBaths={minBaths} updateFilter={updateFilter} />
